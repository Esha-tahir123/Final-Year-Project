...
const CsharpAssessment = () => {
  ...
  useEffect(() => {
    const fetchTasks = () => {
      const shuffledTasks = csharpTasks
        .slice(0, 20)
  ...
  const runHTMLCSSJSCode = () => {
    ...
    setOutput("Code executed successfully in the browser.");
  };
  ...
  const handleSubmitAnswer = async () => {
    ...
    try {
      payload = {
        ...
        language: currentTask.language || "C#",
        task: {
...
export default CsharpAssessment;